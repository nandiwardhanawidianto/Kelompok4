        ...
        <div class="collapse navbar-collapse">
            ...
            <li class="nav-item active">
                ...
                <!-- tambah edit controller -->
                    <li class="nav-item active">
                    <a class="nav-link" href="<?php echo base_url(); ?>index.php/pembelian_con/index2">List Pembelian</a> 
                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo base_url(); ?>index.php/penyakit_con/index2">Penyakit</a>
                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo base_url(); ?>index.php/obat_con/index2">Obat</a>
                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo base_url(); ?>index.php/rs_con/index2">Rumah Sakit</a>
                <li class="nav-item active">
                <li class="nav-item active">
